...
public class OnlineBooksFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_onlinebooks, container, false);

        //ids
        recyclerView = view.findViewById(R.id.onlinebooksRecyclerView);
